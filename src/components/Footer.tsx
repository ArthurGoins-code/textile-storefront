...
export default function Footer() {
  return (
    <footer className="border-t border-slate-200 bg-slate-50 bg-weave text-slate-600">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 lg:grid-cols-4 lg:px-8">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-2 text-sm">
            <li>
              <Link href="/about" className="text-slate-500 transition-colors hover:text-amber-600">
                About us
              </Link>
            </li>
            <li>
              <Link href="/contracts" className="text-slate-500 transition-colors hover:text-amber-600">
                Support plans
              </Link>
            </li>
            <li>
              <Link href="/contact" className="text-slate-500 transition-colors hover:text-amber-600">
                Contact &amp; quotes
              </Link>
            </li>
          </ul>
      ...
      <div className="stitch-divider border-slate-200 py-6 text-center text-xs text-slate-500">
