  ...
  if (orderNumber) {
    return (
      <div className="mx-auto max-w-2xl px-4 py-24 text-center sm:px-6 lg:px-8">
        ...
        <div className="mt-6 inline-flex items-center gap-2 rounded-lg border border-slate-800 bg-slate-900 px-4 py-2 text-sm font-mono text-amber-300">
          Order #{orderNumber}
        </div>
        <div className="mt-8">
          <Link
            href="/contracts"
            className="inline-flex items-center gap-2 rounded-lg bg-amber-400 px-5 py-2.5 text-sm font-semibold text-slate-950 hover:bg-amber-300"
          >
            Continue browsing
          </Link>
        </div>
      ...
      <form onSubmit={handleSubmit} className="mt-10 grid grid-cols-1 gap-10 lg:grid-cols-3">
        <div className="space-y-8 lg:col-span-2">
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            <h2 className="text-lg font-bold text-white">Company & contact</h2>
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            ...
            <div className="mt-4 flex items-start gap-2 rounded-lg bg-slate-800/60 p-3 text-xs text-slate-400">
          ...
          <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            ...
            <ul className="mt-4 space-y-3">
              {orderedLines.map(({ contract, quantity }) => (
                <li key={contract.id} className="flex justify-between text-sm text-slate-300">
                  <span>
            ...
            <button
              type="submit"
              disabled={submitting}
              className="mt-6 w-full rounded-lg bg-amber-400 px-5 py-3 text-sm font-semibold text-slate-950 hover:bg-amber-300 disabled:cursor-not-allowed disabled:opacity-60"
            >
